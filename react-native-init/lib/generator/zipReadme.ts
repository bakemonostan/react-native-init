...
export function buildZipReadme(config: ScaffoldConfig): string {
  const lines = [
    ...
    "  Removes the Components gallery, tab demos, and components/Examples; adds app/(app)/home.tsx",
    "  and points auth + index redirects to /(app)/home. Home title = APP_DISPLAY_NAME (wizard app name).",
    "",
