...
export function buildZipReadme(config: ScaffoldConfig): string {
  const lines = [
    ...
    "  Removes the Components gallery, components/BottomSheetComponents (sheet wrappers), tab demos,",
    "  and components/Examples; adds app/(app)/home.tsx and points auth + index redirects to /(app)/home.",
